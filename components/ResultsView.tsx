  ...
  return (
    <div className="w-full lg:w-[90%] bg-white dark:bg-slate-800 rounded-2xl shadow-2xl p-6 md:p-10 animate-fade-in">
      ...
      <div className="text-center mt-8">
          <button
              onClick={onRestart}
              className="bg-brand-primary hover:bg-indigo-700 text-white font-bold py-3 px-8 rounded-lg text-lg transition-transform transform hover:scale-105 shadow-lg"
          >
              Try Again
          </button>
      </div>
