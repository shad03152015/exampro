    ...
    <div className="w-full lg:w-[90%] bg-slate-900/40 backdrop-blur-2xl border border-slate-700/80 rounded-3xl shadow-2xl shadow-black/30 p-6 md:p-10 flex flex-col animate-slide-in-up">
      ...
      <main className="flex-grow flex flex-col">
        ...
        <textarea
          ...
          className="w-full flex-grow p-4 border border-slate-600/80 rounded-lg focus:ring-2 focus:ring-brand-primary focus:border-brand-primary transition bg-slate-800/50 text-lg text-slate-200 placeholder-slate-500 min-h-[200px]"
        />
