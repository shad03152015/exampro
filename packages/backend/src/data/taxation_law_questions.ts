...
export const TAXATION_LAW_QUESTIONS: Question[] = [
    ...
    // FIX: Completed the question data which was missing an 'Answer' property and was syntactically incorrect.
    {
        "subject": "Taxation Law",
        "No": 16,
        "Question": "Sure Arrival Airways (SAA) is a foreign corporation, organized under the laws of the Republic of Nigeria. Its commercial airplanes do not operate within Philippine territory, or service passengers embarking from Philippine airports. The firm is represented in the Philippines by its general agent, Narotel. SAA sells airplane tickets through Narotel, and these tickets are serviced by SAA airplanes outside the Philippines. The total sales of airplane tickets transacted by Narotel for SAA in 2012 amounted to P10,000,000.00. The Commissioner of Internal Revenue (CIR) assessed SAA deficiency income taxes at the rate of 30% on its taxable income, finding that SAA’s airline ticket sales constituted income derived from sources within the Philippines. SAA filed a protest on the ground that the alleged deficiency income taxes should be considered as income derived exclusively from sources outside the Philippines since SAA only serviced passengers outside Philippine territory. It, thus, contends that it is not liable for income tax from sources within the Philippines. Rule on the protest.",
        "Answer": "The protest should be denied. The income from the sale of tickets in the Philippines is considered as income from sources within the Philippines. The sale of tickets is the activity that produces the income. The flow of wealth occurred within Philippine territory, enjoying the protection of the Philippine government. Therefore, SAA is subject to Philippine income tax on the income derived from its ticket sales in the Philippines. (Commissioner of Internal Revenue v. British Overseas Airways Corporation, G.R. No. L-65773, April 30, 1987)."
    }
];
